...
const CreateForm = () => {
  ...
  const onCreateForm = async () => {
    ...
    let prompt =
      "description " +
      userInput +
      " ,on the basis of description please give me form in json formate with form title,form subheading with input tag name, form name ,placeholder , form label ,fieldType , fieldRequired and form buttons and. just json formate nothing else needed also don't send ```json from start and ``` from end of json formate.";
